...
import { saveTimeSpent } from '../utils/fetch/time';
...
export const TabNavigator = () => {
  ...
  const handleAppStateChange = async () => {
    console.log('out component', dateNow.current);

    saveTimeSpent({ timeStart: dateNow.current })
      .then()
      .catch(async () => {
        await saveTimeSpent({ timeStart: dateNow.current });
      });
  };
